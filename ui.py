...
class ChineseInputPad( gtk.Frame ):
    ...
    def next_punc(self):
        ...
        if self.punc_index > self.punc_page_count:
            self.punc_index = self.punc_page_count
        self.update()
    def prev_punc(self):
        self.punc_index = self.punc_index - 1
...
class InputPad( gtk.Frame ):
    def __init__(self):
        ...
        self.text_view.set_size_request( ChineseInputPad.label_width - 5, 400 - ChineseInputPad.label_height * 2 + ChineseInputPad.height_hint )
